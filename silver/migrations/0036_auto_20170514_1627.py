...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(
            model_name="invoice", old_name="pdf", new_name="pdf_old"
        ),
        migrations.RenameField(
            model_name="proforma", old_name="pdf", new_name="pdf_old"
        ),
        migrations.AddField(
            model_name="invoice",
            name="pdf",
            field=models.ForeignKey(
                to="silver.PDF", null=True, on_delete=django.db.models.deletion.SET_NULL
            ),
        ),
        migrations.AddField(
            model_name="proforma",
        ...
        migrations.RunPython(
            move_pdf_from_documents_to_model, move_pdf_from_model_to_documents
        ),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text=b"The name to be used for billing purposes.",
                        max_length=128,
                    ),
                ),
                ...
                (
                    "extra",
                    models.TextField(
                        help_text=b"Extra information to display on the invoice (markdown formatted).",
                        null=True,
                        blank=True,
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"A flag indicating consolidated billing.",
                    ),
                ),
                (
                    "customer_reference",
                    models.CharField(
                        help_text=b"It's a reference to be passed between silver and clients. It usually points to an account ID.",
                        max_length=256,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=4,
                        blank=True,
                        help_text=b"Whenever to add sales tax. If null, it won't show up on the invoice.",
                        null=True,
                    ),
                ),
                (
                    "sales_tax_name",
                    models.CharField(
                        help_text=b"Sales tax name (eg. 'sales tax' or 'VAT').",
                        max_length=64,
                        null=True,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("archived_customer", models.JSONField(default=dict)),
                ("archived_provider", models.JSONField(default=dict)),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("STD", "STD - S\xe3o Tom\xe9 and Pr\xedncipe Dobra"),
                            ...
                            (
                                "XAF",
                                "XAF - Communaut\xe9 Financi\xe8re Africaine (BEAC) CFA Franc BEAC",
                            ),
                            ...
                            (
                                "XOF",
                                "XOF - Communaut\xe9 Financi\xe8re Africaine (BCEAO) Franc",
                            ),
                            (
                                "XPF",
                                "XPF - Comptoirs Fran\xe7ais du Pacifique (CFP) Franc",
                            ),
                            ("YER", "YER - Yemen Rial"),
                ...
                (
                    "pdf",
                    models.FileField(
                        upload_to=silver.models.documents.base.documents_pdf_path,
                        null=True,
                        editable=False,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=b"month",
                        help_text=b"The frequency with which a subscription should be billed.",
                        max_length=12,
                        choices=[
                            (b"day", b"Day"),
                            (b"week", b"Week"),
                ...
                (
                    ...
                    models.CharField(
                        default=b"USD",
                        help_text=b"The currency in which the subscription will be charged.",
                        max_length=4,
                        choices=[
                            ("USD", "USD - United States Dollar"),
                            ("EUR", "EUR - Euro Members"),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text=b"Number of seconds to wait after current billing cycle ends before generating the invoice. This can be used to allow systems to finish updating feature counters.",
                    ),
                ),
                (
                    "enabled",
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text=b"A list of the plan's metered features.",
                        to="silver.MeteredFeature",
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=b"proforma",
                        help_text=b"One of the available workflows for generating proformas and                   invoices (see the documentation for more details).",
                        max_length=10,
                        choices=[(b"proforma", b"Proforma"), (b"invoice", b"Invoice")],
                    ),
                ),
                (
                    "invoice_series",
                    models.CharField(
                        help_text=b"The series that will be used on every invoice generated by                   this provider.",
                        max_length=20,
                    ),
                ),
                ...
                (
                    "proforma_series",
                    models.CharField(
                        help_text=b"The series that will be used on every proforma generated by                   this provider.",
                        max_length=20,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        default=b"draft",
                        help_text=b"The default state of the auto-generated documents.",
                        max_length=10,
                        choices=[(b"draft", b"Draft"), (b"issued", b"Issued")],
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "trial_end",
                    models.DateField(
                        help_text=b"The date at which the trial ends. If set, overrides the computed trial end date from the plan.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    "start_date",
                    models.DateField(
                        help_text=b"The starting date for the subscription.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    "ended_at",
                    models.DateField(
                        help_text=b"The date when the subscription ended.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    "reference",
                    models.CharField(
                        help_text=b"The subscription's reference in an external system.",
                        max_length=128,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    ...
                    django_fsm.FSMField(
                        default=b"inactive",
                        help_text=b"The state the subscription is in.",
                        protected=True,
                        max_length=12,
                        choices=[
                            (b"active", b"Active"),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="silver.Customer",
                        help_text=b"The customer who is subscribed to the plan.",
                        on_delete=django.db.models.deletion.CASCADE,
                    ),
                ),
                (
                    "plan",
                    models.ForeignKey(
                        help_text=b"The plan the customer is subscribed to.",
                        to="silver.Plan",
                        on_delete=django.db.models.deletion.CASCADE,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="silver.Provider", on_delete=django.db.models.deletion.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="plan",
        ...
        migrations.AlterUniqueTogether(
            name="meteredfeatureunitslog",
            unique_together=set(
                [("metered_feature", "subscription", "start_date", "end_date")]
            ),
        ),
        migrations.AlterUniqueTogether(
            name="invoice",

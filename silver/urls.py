...
urlpatterns = [
    ...
    re_path(
        r"^autocomplete/invoices/$",
        InvoiceAutocomplete.as_view(),
        name="autocomplete-invoice",
    ),
    re_path(
        r"^autocomplete/proformas/$",
        ProformaAutocomplete.as_view(),
        name="autocomplete-proforma",
    ),
    re_path(
        r"^autocomplete/payment-method/$",
        PaymentMethodAutocomplete.as_view(),
        name="autocomplete-payment-method",
    ),
    re_path(
        r"^autocomplete/plan/$", PlanAutocomplete.as_view(), name="autocomplete-plan"
    ),
    re_path(

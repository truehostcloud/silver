...
class Customer(BaseBillingEntity):
    ...
    first_name = models.CharField(
        max_length=128, help_text="The customer's first name."
    )
    last_name = models.CharField(max_length=128, help_text="The customer's last name.")

    payment_due_days = models.PositiveIntegerField(
        default=PAYMENT_DUE_DAYS, help_text="Due days for generated proforma/invoice."
    )

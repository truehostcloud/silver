    ...
    def test_post_provider_without_required_fields(self):
        ...
        for field in required_fields:
            ...
            try:
                ...
                pytest.xfail(
                    "Required field %s for Provider not provided"
            ...
            for response_item in response.data.items():
                ...
                valid_responses = [
                    ...
                    (
                        field_name,
                        ["This field is required as the chosen flow " "is proforma."],
                    ),
                ]
        ...
        request_body = [
            {
                ...
                "live": True,
                "meta": {"something": [0, 1]},
                "address_1": "Add\xe3ress10",
                "address_2": "Add\xe5ress20",
                "proforma_starting_number": 1,
                "invoice_series": "InvoiceSeries",
                "email": "provider0@email.com",
                "zip_code": "0",
            },
            {
                "city": "Cit\u01771",
                ...
                "live": True,
                "meta": {"something": [2, 3]},
                "address_1": "Add\xe3ress11",
                "address_2": "Add\xe5ress21",
                "proforma_starting_number": 1,
                "invoice_series": "InvoiceSeries",
                "email": "provider10@email.com",
                "zip_code": "1",
            },
        ]

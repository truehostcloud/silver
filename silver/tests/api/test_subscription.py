...
class TestSubscriptionEndpoint(APITestCase):
    ...
    def test_cancel_subscription(self):
        ...
        response = self.client.post(
            url,
            json.dumps({"when": "end_of_billing_cycle"}),
            content_type="application/json",
        )
    ...
    def test_end_subscription(self):
        ...
        response = self.client.post(
            url, json.dumps({"when": "now"}), content_type="application/json"
        )
    ...
    def test_get_subscription_detail_unexisting(self):
        ...
        url = reverse(
            "subscription-detail",
            kwargs={"subscription_pk": 42, "customer_pk": customer.pk},
        )
    ...
    def test_create_subscription_mf_units_log_active_sub(self):
        ...
        response = self.client.patch(
            url,
            json.dumps({"count": 150, "date": date, "update_type": "absolute"}),
            content_type="application/json",
        )
        ...
        response = self.client.patch(
            url,
            json.dumps({"count": 29, "date": date, "update_type": "relative"}),
            content_type="application/json",
        )
    ...
    def test_create_subscription_mf_units_log_with_invalid_date(self):
        ...
        response = self.client.patch(
            url,
            json.dumps({"count": 150, "date": "2008-12-24", "update_type": "absolute"}),
            content_type="application/json",
        )
    ...
    def test_create_subscription_mf_units_log_with_insufficient_data(self):
        ...
        for field in data:
            ...
            response = self.client.patch(
                url, json.dumps(data_copy), content_type="application/json"
            )
